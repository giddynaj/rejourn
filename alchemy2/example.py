...
content_sql = 'select content from news where id = 7214' 
sql = 'select title from news where id = 7214' 
sql = 'select link from news where id = 7214' 

demo_url = 'http://www.mercurynews.com/crime-courts/ci_27043759/facebook-threats-free-speech-supreme-court-decide'
req = urllib2.Request(demo_url,None)
opener = urllib2.build_opener()
f = opener.open(req)
demo_html = str(f.read())

cur.execute(content_sql)
demo_text = cur.fetchone()
image_url = ''
